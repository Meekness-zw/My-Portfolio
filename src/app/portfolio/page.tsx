...
const items = [
  {
    ...
    title: "Manage",
    desc: "One of my first projects, created using tailwid and html",
    img: "/Flexbox.png",
  ...
  },
  {
    ...
    title: "Nyamatusi",
    desc: "A responsive website crafted with html and css styles",
    img: "/Nyamatusi.png",
    link: "https://meekness-zw.github.io/Nyamatusi/",
  },
  {
    id: 3,
    color: "from-violet-300 to-purple-300",
    title: "Daas Africa",
    desc: "Indulge in the Daas Africa design ",
    img: "/Daas.png",
    link: "https://lama.dev",
  },
  {
    ...
    title: "Meals For Hope",
    desc: "Meals for Hope website",
    img: "/Mobi.png",
    link: "https://lama.dev",
  },
];
      ...
      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center">
        ...
        <div className="relative">
          <motion.svg animate={{ rotate: 360 }} transition={{ duration: 8, ease: "linear", repeat: Infinity }} viewBox='0 0 300 300' className='w-64 h-64 md:w-[500px] md:h-[500px]'>
            ...
            <text fill="#000">
              <textPath xlinkHref='#circlePath' className='text-xl'>Full-stack Developer and UX/UI Designer</textPath>
            </text>
          </motion.svg>
          <Link href="/contact"
